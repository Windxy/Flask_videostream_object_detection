...
if __name__=='__main__':
    ...
    parser.add_argument('--imgpath', type=str, default='coco/person.jpg', help="image path")
    parser.add_argument('--modelpath', type=str, default='coco/picodet_s_416_coco.onnx', choices=["coco/picodet_m_320_coco.onnx", "coco/picodet_m_416_coco.onnx", "coco/picodet_s_320_coco.onnx", "coco/picodet_s_416_coco.onnx"], help="onnx filepath")
